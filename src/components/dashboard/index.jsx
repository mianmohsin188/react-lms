...
import {logout} from "../../store/auth/authSlice.jsx";
import dashboardIllustration from "../../assets/img/illustrations/man-with-laptop-light.png";
...
function Index() {
    ...
    const username =  typeof(user)==='string'?(JSON.parse(user)?.firstName):user?.firstName;
   // const dashboardIllustration = "../../assets/img/illustrations/man-with-laptop.png";
    return (
        <>
            <div className="row">
                        ...
                        <div className="d-flex align-items-end row">
                            <div className="col-sm-7">
                                <div className="card-body">
                                    <h5 className="card-title text-primary">Welcome {username}  🎉</h5>
                                    <p className="mb-4">
                        ...
                        <div className="col-6 mb-4">
                            <div className="card">
                                <div className="card-body">
                                    <div className="card-title d-flex align-items-start justify-content-between">
                                        <div className="avatar flex-shrink-0">
                                            <img src={ccPrimary} alt="Credit Card"
                                                 className="rounded"/>
                                        </div>
                                        <div className="dropdown">
                                            <button
